...
Public Class LeaveSalaryReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HR_Management_System.LeaveSalaryReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLeaveSalaryReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LeaveSalaryReport = New LeaveSalaryReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
