...
Public Class TraningCertificate
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HR_Management_System.TraningCertificate.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Certificate() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedTraningCertificate
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TraningCertificate = New TraningCertificate()
        rpt.Site = Me.Site
        Return rpt
    End Function
